...
static NSString * const kConsumerKey       = @"eRbK213s2kRqXKxxosh0jw";
static NSString * const kConsumerSecret    = @"FDsiVETvjRKoaEGiLLkpklyCKOo";
static NSString * const kToken             = @"CVBXvRpvhtZvbJlgUWs5wbs1TIXfHTLp";
static NSString * const kTokenSecret       = @"YeT6aLGylHij3AsqML3RyiqJJ1k";
